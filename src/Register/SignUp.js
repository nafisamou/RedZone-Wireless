...
const SignUp = () => {
  ...
  const handleSignUp = (data) => {
    ...
    const saveUser = (
      ...
      console.log(user);
      fetch("https://task-4-server-nine.vercel.app/users", {
        method: "POST",
        headers: {
  ...
  return (
    <div className="h-[550px] flex justify-center items-center border-t-8 border-b-8  my-10 shadow-xl lg:w-3/6 mx-auto px-40 py-10 ">
